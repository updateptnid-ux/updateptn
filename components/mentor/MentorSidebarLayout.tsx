    ...
    <div className="min-h-screen bg-slate-50/70 flex flex-col md:flex-row font-sans">
      ...
      <header className="md:hidden bg-white/80 backdrop-blur-md border-b border-slate-200/80 h-16 px-4 flex items-center justify-between sticky top-0 z-40 shadow-xs">
        ...
        <Sheet open={isMobileOpen} onOpenChange={setIsMobileOpen}>
          <SheetTrigger render={
            <Button variant="outline" size="icon" className="rounded-xl border-slate-200/80">
              ...
              <SheetHeader>
                <SheetTitle className="flex items-center gap-2 text-left">
                  ...
                  <div>
                    ...
                    <span className="text-[11px] font-semibold text-blue-500 block">Mentor Panel</span>
                  </div>
                </SheetTitle>
              </SheetHeader>
      ...
      <aside className="hidden md:flex flex-col w-64 bg-white border-r border-slate-200 p-6 justify-between shrink-0 sticky top-0 h-screen">
        <div className="space-y-8">
          ...
          <div className="flex items-center gap-2 bg-blue-50 border border-blue-200/70 rounded-xl px-3 py-2">
            ...
            <span className="text-[11px] font-bold text-blue-600 leading-tight">Panel Khusus Mentor</span>
          </div>
        ...
        <div className="space-y-4 pt-6 border-t border-slate-200">
          <div className="flex items-center gap-3 p-2 rounded-xl bg-blue-50/60 border border-blue-200/60">
            ...
            <div className="overflow-hidden">
              ...
              <p className="text-[11px] text-blue-500 truncate font-semibold">Mentor</p>
            </div>
          </div>
