    ...
    <div className="min-h-screen flex flex-col bg-white text-slate-900 font-sans selection:bg-blue-100 selection:text-blue-900">
      ...
      <section className="py-20 md:py-28 bg-gradient-to-b from-blue-50/50 via-white to-white border-b border-slate-200/80 relative overflow-hidden">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8 relative z-10">
          ...
          <FadeIn delay={0.15} className="pt-8 border-t border-slate-200/60 max-w-3xl mx-auto space-y-4">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2.5 sm:gap-4">
              {["UI", "ITB", "UGM", "ITS", "UNPAD", "AIRLANGGA", "UB", "UNS"].map((univ) => (
                <Badge
                  key={univ}
                  variant="outline"
                  className="bg-white/80 border-slate-200/80 text-slate-700 font-bold text-xs px-3 py-1 shadow-2xs hover:border-blue-300 transition-colors"
                >
                  {univ}
                </Badge>
              ))}
          ...
          <StaggerContainer className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center" staggerDelay={0.08}>
            <StaggerItem>
              <div className="space-y-1 p-4 rounded-2xl bg-white/5 border border-white/10">
                <p className="text-3xl sm:text-4xl font-black text-blue-400">50.000+</p>
                <p className="text-xs sm:text-sm font-semibold text-slate-300">Bank Soal & Pembahasan</p>
              </div>
            </StaggerItem>
            ...
            <StaggerItem>
              <div className="space-y-1 p-4 rounded-2xl bg-white/5 border border-white/10">
                ...
                <p className="text-xs sm:text-sm font-semibold text-slate-300">Akurasi Penilaian IRT</p>
              </div>
            </StaggerItem>
            ...
            <StaggerItem>
              <div className="space-y-1 p-4 rounded-2xl bg-white/5 border border-white/10">
                ...
                <p className="text-xs sm:text-sm font-semibold text-slate-300">PTN & 4.900+ Prodi</p>
              </div>
            </StaggerItem>

            <StaggerItem>
              <div className="space-y-1 p-4 rounded-2xl bg-white/5 border border-white/10">
                <p className="text-3xl sm:text-4xl font-black text-indigo-400">98%</p>
                <p className="text-xs sm:text-sm font-semibold text-slate-300">Kepuasan Siswa Tembus PTN</p>
              </div>
            </StaggerItem>
          </StaggerContainer>
        </div>
