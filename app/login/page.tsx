...
import { PageTransition, MotionCard, MotionButton } from "@/components/ui/fade-in";
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center px-4 py-12 bg-slate-50/70 font-sans relative">
      <div className="w-full max-w-md space-y-6">
        {/* Back to Home Button & Brand Header */}
        ...
        {/* Login Card (Glassmorphic & Pseudo-3D Layering) */}
        <MotionCard className="rounded-2xl">
          <Card className="border border-slate-200/80 shadow-xl rounded-2xl bg-white/95 backdrop-blur-md overflow-hidden p-2 sm:p-4">
            <CardHeader className="space-y-1.5 text-center pb-4">
              <CardTitle className="text-2xl font-extrabold text-slate-900 tracking-tight">Selamat Datang Kembali</CardTitle>
            ...
            <CardContent className="space-y-5">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <MotionButton className="w-full mt-2">
                  <Button
                    type="submit"
                    disabled={isPending}
