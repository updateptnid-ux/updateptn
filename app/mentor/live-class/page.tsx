...
import { insertLiveClass, updateLiveClass, deleteLiveClass } from "@/actions/mentor-crud";
...
export default function MentorLiveClassPage() {
  ...
  const handleSave = async () => {
    try {
      ...
      let result;
      if (editingClass) {
        result = await updateLiveClass(editingClass.id, formData);
      } else {
        result = await insertLiveClass(formData);
      }
                  ...
                  >
                    ...
                    <TableCell>
                      <div className="flex flex-col gap-1">
                        ...
                        {lc.is_premium && (
                          <Badge className="bg-blue-50 text-blue-700 border-blue-200 text-[10px] font-bold w-fit">
                            Premium
                          </Badge>
                        )}
                      </div>
                    ...
                    <TableCell className="text-right">
                      <div className="flex items-center justify-end gap-2">
                        <Button
                          ...
                          className="h-8 px-3 rounded-lg hover:border-violet-300 hover:text-blue-700"
                        >
