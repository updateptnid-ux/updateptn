...
export default function MentorHomePage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      {/* Hero Greeting */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-violet-600 via-violet-700 to-purple-800 p-8 text-white shadow-xl shadow-violet-200">
        {/* decorative blobs */}
        <div className="absolute top-0 right-0 w-64 h-64 bg-white/5 rounded-full -translate-y-32 translate-x-32 blur-3xl" />
        <div className="absolute bottom-0 left-0 w-48 h-48 bg-violet-400/20 rounded-full translate-y-24 -translate-x-24 blur-2xl" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-3 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Link href="/dashboard/mentor/live-class">
              <Button
                variant="ghost"
                size="sm"
                className="text-violet-600 hover:bg-violet-50 text-xs font-semibold rounded-xl gap-1"
              >
            ...
            {loading ? (
              ...
              <Card className="p-8 rounded-2xl bg-white border border-slate-100 text-center">
                ...
                <Link href="/dashboard/mentor/live-class">
                  <Button
                    size="sm"
                    className="mt-3 bg-violet-600 hover:bg-violet-700 text-white rounded-xl text-xs"
                  >
                    Tambah Sekarang
                  </Button>
                </Link>
              ...
              liveClasses.map((lc) => {
                ...
                return (
                  <Card
                    key={lc.id}
                    className="p-4 rounded-2xl bg-white border border-slate-100 hover:border-violet-200 hover:shadow-sm transition-all"
                  >
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Link href="/dashboard/mentor/video">
              <Button
                variant="ghost"
                size="sm"
          ...
          {/* Quick Actions */}
          <Card className="p-4 rounded-2xl bg-gradient-to-br from-violet-50 to-purple-50 border border-violet-200/60">
            ...
            <div className="space-y-2">
              <Link href="/dashboard/mentor/live-class">
                <Button
                  variant="outline"
                  size="sm"
                  className="w-full justify-start text-xs font-semibold border-violet-200 text-violet-700 hover:bg-violet-100 rounded-xl gap-2 mb-2"
                >
              ...
              <Link href="/dashboard/mentor/modul">
                <Button
                  variant="outline"
                  size="sm"
                  className="w-full justify-start text-xs font-semibold border-emerald-200 text-emerald-700 hover:bg-emerald-50 rounded-xl gap-2"
                >
