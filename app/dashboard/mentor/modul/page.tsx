    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <Button
          ...
          className="bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-xl gap-2 shadow-md shadow-emerald-200 shrink-0"
        >
        ...
        {loading ? (
          <div className="p-12 text-center">
            <div className="inline-flex items-center gap-2 text-slate-400">
              <BookOpen className="h-5 w-5 animate-pulse text-emerald-400" />
                  ...
                  <TableCell className="text-right">
                    <div className="flex items-center justify-end gap-2">
                      <Button
                        ...
                        className="h-8 px-3 rounded-lg hover:border-emerald-300 hover:text-emerald-700"
                      >
          ...
          <div className="space-y-4 py-2">
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                rows={3}
                className="w-full rounded-xl border border-input bg-background px-3 py-2 text-sm text-slate-700 resize-none focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-400"
              />
            </div>
